...
export interface StripePrices {
  ...
  TEMPO_EXTRAS_MONTHLY_CLUB: string;
  TEMPO_EXTRAS_YEARLY_CLUB: string;
  TENURE_EXTRAS_MONTHLY_CLUB: string;
  TENURE_EXTRAS_YEARLY_CLUB: string;
...
export function mapPriceToProduct(priceId: string | undefined): string | null {
  ...
  const testPriceMap: Record<string, string> = {
    ...
    [STRIPE_PRICES_TEST.TEMPO_EXTRAS_MONTHLY_CLUB]: 'tempo_extras',
    [STRIPE_PRICES_TEST.TEMPO_EXTRAS_YEARLY_CLUB]: 'tempo_extras',
    [STRIPE_PRICES_TEST.TENURE_EXTRAS_MONTHLY]: 'tenure_extras',
    [STRIPE_PRICES_TEST.TENURE_EXTRAS_YEARLY]: 'tenure_extras',
    [STRIPE_PRICES_TEST.TENURE_EXTRAS_MONTHLY_CLUB]: 'tenure_extras',
    [STRIPE_PRICES_TEST.TENURE_EXTRAS_YEARLY_CLUB]: 'tenure_extras',
  ...
  const livePriceMap: Record<string, string> = {
    ...
    [STRIPE_PRICES_LIVE.TEMPO_EXTRAS_MONTHLY_CLUB]: 'tempo_extras',
    [STRIPE_PRICES_LIVE.TEMPO_EXTRAS_YEARLY_CLUB]: 'tempo_extras',
    [STRIPE_PRICES_LIVE.TENURE_EXTRAS_MONTHLY]: 'tenure_extras',
    [STRIPE_PRICES_LIVE.TENURE_EXTRAS_YEARLY]: 'tenure_extras',
    [STRIPE_PRICES_LIVE.TENURE_EXTRAS_MONTHLY_CLUB]: 'tenure_extras',
    [STRIPE_PRICES_LIVE.TENURE_EXTRAS_YEARLY_CLUB]: 'tenure_extras',
