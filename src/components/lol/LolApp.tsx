...
const sampleMembers: HouseholdMember[] = [
  { id: '1', name: 'You', avatar: '', color: '#2196F3', totalPoints: 1245, weeklyPoints: 320, streak: 7, level: 12, achievements: ['Early Bird', 'Kitchen Master'] },
  { id: '2', name: 'Partner', avatar: '', color: '#E91E63', totalPoints: 1180, weeklyPoints: 285, streak: 5, level: 11, achievements: ['Laundry Pro', 'Streak Master'] },
];

const sampleChores: Chore[] = [
  { id: '1', name: 'Do the dishes', category: 'kitchen', estimatedMinutes: 15, points: 25, frequency: 'daily', icon: 'dishes' },
  { id: '2', name: 'Vacuum living room', category: 'general', estimatedMinutes: 20, points: 35, frequency: 'weekly', icon: 'vacuum' },
  { id: '3', name: 'Laundry - wash & fold', category: 'laundry', estimatedMinutes: 45, points: 50, frequency: 'weekly', icon: 'laundry' },
  { id: '4', name: 'Clean bathroom', category: 'bathroom', estimatedMinutes: 30, points: 45, frequency: 'weekly', icon: 'bathroom' },
  { id: '5', name: 'Take out trash', category: 'general', estimatedMinutes: 5, points: 10, frequency: 'daily', icon: 'trash' },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        'box-shadow': isHovered() ? paperElevation[hoverElevation] : paperElevation[baseElevation as keyof typeof paperElevation],
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            gap: '12px',
            padding: '8px 16px',
            background: happinessScore >= 75 ? '#E8F5E9' : happinessScore >= 50 ? '#FFF3E0' : '#FFEBEE',
            'border-radius': '50px',
          }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill={happinessScore >= 75 ? '#4CAF50' : happinessScore >= 50 ? '#FF9800' : '#F44336'}>
              <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm3.5-9c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-7 0c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm3.5 6.5c2.33 0 4.31-1.46 5.11-3.5H6.89c.8 2.04 2.78 3.5 5.11 3.5z"/>
            </svg>
            <span style={{
              'font-size': '14px',
              'font-weight': '600',
              color: happinessScore >= 75 ? '#2E7D32' : happinessScore >= 50 ? '#E65100' : '#C62828',
            }}>
      ...
      <div style={{ 'max-width': '900px', margin: '0 auto', padding: '24px' }}>
        ...
        <nav style={{
          ...
          {(['chores', 'leaderboard', 'rewards'] as const).map(tab => (
            <button
        ...
        {activeTab() === 'chores' && (
          <>
            ...
            <For each={sampleChores}>
              {chore => <ChoreItem chore={chore} />}
            </For>
          ...
          <>
            <div style={{
              ...
              <div style={{ display: 'grid', 'grid-template-columns': 'repeat(2, 1fr)', gap: '16px' }}>
                {[
                  { title: 'Movie Night Pick', points: 200, icon: 'M18 4l2 4h-3l-2-4h-2l2 4h-3l-2-4H8l2 4H7L5 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4h-4z' },
                  { title: 'Sleep In Pass', points: 350, icon: 'M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm.5-11.5h-1v6l5.2 3.15.8-1.3-5-3V7.5z' },
                  { title: 'Dinner Choice', points: 500, icon: 'M11 9H9V2H7v7H5V2H3v7c0 2.12 1.66 3.84 3.75 3.97V22h2.5v-9.03C11.34 12.84 13 11.12 13 9V2h-2v7zm5-3v8h2.5v8H21V2c-2.76 0-5 2.24-5 4z' },
                  { title: 'Back Massage', points: 750, icon: 'M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z' },
                ].map(reward => (
                  <PaperCard elevation={1} style={{ padding: '20px', 'text-align': 'center' }}>
                    <div style={{
                      ...
                      <svg width="24" height="24" viewBox="0 0 24 24" fill={papermorphic.colors.primary}>
                        <path d={reward.icon}/>
                      </svg>
                    </div>
                    <h3 style={{
