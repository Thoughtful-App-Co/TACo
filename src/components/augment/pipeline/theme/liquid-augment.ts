/**
 * Liquid-Augment Theme - Blends Maximalist base with Liquid motion design
 *
...
// ============================================================================
// LIQUID AUGMENT THEME
// ============================================================================

export const liquidAugment = {
...
export const pipelineStyles = {
  card: {
    ...
    backdropFilter: liquidAugment.glass.backdropFilter,
    borderRadius: liquidAugment.radii.card,
    transition: `all ${pipelineAnimations.normal} ${pipelineAnimations.flow}`,
  },

  cardHover: {
    transform: 'translateY(-2px)',
    boxShadow: liquidAugment.shadows.cardHover,
  },

  button: {
    padding: '12px 24px',
    borderRadius: liquidAugment.radii.button,
    fontWeight: '600',
  ...
  buttonPrimary: {
    ...
    color: 'white',
    border: 'none',
    boxShadow: liquidAugment.shadows.glow(maximalist.colors.primary),
  },
  ...
  input: {
    width: '100%',
    padding: '14px 16px',
    background: liquidAugment.colors.background,
  ...
  inputFocus: {
    borderColor: liquidAugment.colors.primary,
  },
  ...
  badge: {
    ...
    gap: '6px',
    padding: '4px 12px',
    borderRadius: liquidAugment.radii.pill,
    fontSize: '12px',
    fontWeight: '600',
  },
