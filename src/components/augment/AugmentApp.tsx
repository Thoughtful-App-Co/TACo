...
const ARCHETYPES: Record<string, { title: string; description: string }> = {
  ...
  'realistic': { title: 'The Maker', description: 'You thrive when building, fixing, and working with your hands.' },
  'investigative': { title: 'The Thinker', description: 'You analyze, research, and solve complex problems logically.' },
  'artistic': { title: 'The Creator', description: 'You express yourself through innovative design and creative works.' },
  'social': { title: 'The Helper', description: 'You empower others through teaching, healing, and guidance.' },
  'enterprising': { title: 'The Persuader', description: 'You lead teams and sell ideas with energy and confidence.' },
  'conventional': { title: 'The Organizer', description: 'You create order and efficiency through structured systems.' },
  // Hybrid Combinations (sorted alphabetically by key for lookup)
  'investigative-realistic': { title: 'The Engineer', description: 'You combine practical skills with analytical depth to build functional solutions.' },
  'artistic-realistic': { title: 'The Artisan', description: 'You craft beautiful, tangible objects with skill and creative flair.' },
  'realistic-social': { title: 'The Service Technician', description: 'You use practical skills to directly help others in tangible ways.' },
  'enterprising-realistic': { title: 'The Contractor', description: 'You manage projects and lead teams in hands-on environments.' },
  'conventional-realistic': { title: 'The Builder', description: 'You execute precise, structured work with tangible materials.' },
  'artistic-investigative': { title: 'The Architect', description: 'You merge creative vision with rigorous logic to design complex systems.' },
  'investigative-social': { title: 'The Diagnostician', description: 'You analyze problems to provide deep care and understanding for people.' },
  'enterprising-investigative': { title: 'The Strategist', description: 'You use data and analysis to lead organizations toward success.' },
  'conventional-investigative': { title: 'The Analyst', description: 'You organize data and systems with scientific precision.' },
  'artistic-social': { title: 'The Teacher', description: 'You use creativity to inspire and educate others.' },
  'artistic-enterprising': { title: 'The Innovator', description: 'You turn creative ideas into marketable products and ventures.' },
  'artistic-conventional': { title: 'The Editor', description: 'You bring structure and polish to creative output.' },
  'enterprising-social': { title: 'The Community Leader', description: 'You bring people together to achieve shared goals through influence.' },
  'conventional-social': { title: 'The Administrator', description: 'You support people through efficient, well-managed systems.' },
  'conventional-enterprising': { title: 'The Executive', description: 'You manage business operations with structure and authority.' },
};
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ 'margin-bottom': '32px' }}>
          <h3 style={{ 'font-size': '20px', 'margin-bottom': '8px', color: currentTheme().colors.accent }}>What they do</h3>
        ...
        <div style={{ 'margin-bottom': '32px' }}>
          <h3 style={{ 'font-size': '20px', 'margin-bottom': '8px', color: currentTheme().colors.secondary }}>On the job</h3>
        ...
        {props.job.also_called && (
          <div>
            <h3 style={{ 'font-size': '20px', 'margin-bottom': '8px', color: maximalist.colors.textMuted }}>Also called</h3>
...
const RadarChart: Component<{ scores: RiasecScoreWithDetails }> = (props) => {
  const [hoveredPoint, setHoveredPoint] = createSignal<{ x: number; y: number; label: string; score: number; color: string } | null>(null);
  ...
  const polygonPoints = createMemo(() => dataPoints().map(p => `${p.x},${p.y}`).join(' '));
    ...
    <div style={{ position: 'relative', width: '300px', height: '300px', margin: '0 auto' }}>
      ...
      <Show when={hoveredPoint()}>
        <div style={{
          ...
          <span style={{ 'font-weight': 'bold', 'text-transform': 'capitalize', color: hoveredPoint()!.color }}>
            {hoveredPoint()!.label}
          </span>
    ...
    >
      ...
      <div style={{ position: 'relative', 'z-index': 1 }}>
        ...
        <div style={{
          ...
          <span style={{
            'font-size': '12px',
            color: currentTheme().colors.textOnPrimary === 'white' ? 'rgba(255,255,255,0.8)' : 'rgba(0,0,0,0.6)',
            'font-weight': '500',
          }}>
            / 100
          </span>
        ...
        <div style={{ position: 'relative', 'z-index': 1 }}>
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                'font-size': '10px',
                color: currentTheme().colors.textOnPrimary === 'white' ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.5)',
                'text-transform': 'uppercase',
                'letter-spacing': '1px',
              }}>
                Match
        ...
        <div style={{ display: 'grid', 'grid-template-columns': '1fr 1fr', gap: '16px', 'margin-bottom': '20px' }}>
          <div>
            <div style={{
              ...
              <span style={{ color: currentTheme().colors.primary, 'font-weight': '600' }}>{props.job.strengthFitScore}%</span>
            </div>
            <div style={{
              height: '8px',
          ...
          <div>
            <div style={{
              ...
              <span style={{ color: currentTheme().colors.secondary, 'font-weight': '600' }}>{props.job.cultureFitScore}%</span>
            </div>
            <div style={{
              height: '8px',
...
export const AugmentApp: Component = () => {
  ...
  // Assessment State
  const [assessmentState, setAssessmentState] = createSignal<'intro' | 'questions' | 'results'>('intro');
  ...
  const enrichCareers = async (careers: OnetCareerMatch[]) => {
    ...
    const enriched = await Promise.all(topCareers.map(async (c, i) => {
      ...
      return {
        ...
        matchedStrengths: details?.skills ? details.skills.slice(0, 3) : ['Analytical', 'Creative'],
        matchedValues: c.tags.green ? ['Green Economy'] : (c.tags.bright_outlook ? ['High Growth'] : ['Stability']),
        status: 'discovered'
      } as JobMatch;
    }));
    setJobs(enriched);
        ...
        <div style={{ position: 'relative', 'z-index': 1 }}>
          ...
          <nav style={{
            ...
            <div style={{
              ...
              {(['RIASEC', 'Matches'] as const).map(tab => (
                <button
                  onClick={() => setActiveTab(tab)}
                  style={{
                    padding: '14px 28px',
                    background: activeTab() === tab ? currentTheme().gradients.primary : 'transparent',
                    border: 'none',
                    'border-radius': maximalist.radii.md,
                    color: activeTab() === tab ? currentTheme().colors.textOnPrimary : maximalist.colors.textMuted,
                    'font-size': '14px',
                    'font-weight': '600',
                    cursor: 'pointer',
          ...
          {activeTab() === 'Matches' && (
            <>
              ...
              <Show when={jobs().length > 0} fallback={
                <div style={{ padding: '48px', 'text-align': 'center', color: maximalist.colors.textMuted }}>
                  <p>Complete the RIASEC assessment to see your matched opportunities.</p>
                  <button onClick={() => setActiveTab('RIASEC')} style={{
                    'margin-top': '16px',
                    padding: '12px 24px',
                    background: currentTheme().gradients.primary,
                    color: currentTheme().colors.textOnPrimary,
              ...
              <Show when={assessmentState() === 'intro'}>
                <div style={{ 'text-align': 'center' }}>
                  ...
                  <p style={{
                    ...
                    This 60-question assessment provides personalized insights into your work interests.
                  </p>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {[
                      ...
                      >
                        <span style={{ 'font-size': '24px', 'font-weight': 'bold', color: opt.color }}>
                          {opt.val === 1 ? '😡' : opt.val === 2 ? '🙁' : opt.val === 3 ? '😐' : opt.val === 4 ? '🙂' : '😍'}
                        </span>
                        <span style={{ 'font-size': '12px', 'text-align': 'center' }}>{opt.label}</span>
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h2 style={{
                      ...
                      <span style={{ color: (maximalist.riasec as any)[hybridArchetype()!.types[0]] }}>
                        {hybridArchetype()!.types[0]}
                      </span>
                      <span style={{ color: maximalist.colors.textMuted }}>+</span>
                      <span style={{ color: (maximalist.riasec as any)[hybridArchetype()!.types[1]] }}>
                  ...
                  <div style={{
                    ...
                    <Show when={!isLoading()} fallback={<div style={{'grid-column': '1/-1', 'text-align': 'center'}}>Loading recommendations...</div>}>
