...
const FEATURE_CONFIGS: Record<string, FeatureConfig> = {
  tenure_extras: {
    title: 'Tenure Extras',
    description: 'AI-powered resume and cover letter tools.',
    benefits: [
      '20 AI credits per month',
      'AI Resume Upload',
      'Job-Based Resume Generation',
...
export const Paywall: Component<PaywallProps> = (props) => {
  ...
  const handleDontRemindToggle = (checked: boolean) => {
    setDontRemindChecked(checked);
    if (props.onDontRemindChange) {
      props.onDontRemindChange(checked);
    }
  };
          ...
          >
            ...
            >
              ...
              <div style={{ padding: '24px 32px 32px' }}>
                ...
                <Show when={props.showDontRemind}>
                  <label
                    style={{
                      display: 'flex',
                      'align-items': 'center',
                  ...
                  >
                    <input
                      ...
                      onChange={(e) => handleDontRemindToggle(e.currentTarget.checked)}
                      style={{
                        width: '16px',
                        height: '16px',
                        cursor: 'pointer',
