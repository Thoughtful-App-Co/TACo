...
const IconExportNav: Component<{ size?: number; color?: string }> = (props) => (
  <svg
    width={props.size || 24}
    height={props.size || 24}
    viewBox="0 0 24 24"
...
const PROSPER_NAV_ITEMS: MobileDrawerNavItem[] = [
  ...
  { id: 'export', label: 'Export', icon: IconExportNav, ariaLabel: 'Export data' },
];
...
export const ExportView: Component<ExportViewProps> = (props) => {
  ...
  return (
    ...
    >
      <PageHeader subtitle="Export your career data" theme={props.currentTheme} />
