...
const IconReviewNav: Component<{ size?: number; color?: string }> = (props) => (
  <svg
    width={props.size || 24}
    height={props.size || 24}
    viewBox="0 0 24 24"
...
const PROSPER_NAV_ITEMS: MobileDrawerNavItem[] = [
  ...
  { id: 'reviews', label: '360 Reviews', icon: IconReviewNav, ariaLabel: '360 Reviews' },
...
export const ReviewsView: Component<ReviewsViewProps> = (props) => {
  ...
  return (
    ...
    >
      <PageHeader subtitle="Collect and manage feedback" theme={props.currentTheme} />
