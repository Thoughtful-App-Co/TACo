...
const sampleCase: Case = {
  ...
  description: 'Wrongful withholding of security deposit after move-out on September 15, 2024. Property was left in good condition with documented evidence.',
  filingDate: new Date('2024-10-01'),
  courtDate: new Date('2024-12-15'),
};

const sampleEvidence: Evidence[] = [
  { id: '1', caseId: '1', type: 'photo', title: 'Move-out Photos', description: 'Dated photographs showing property condition', dateAdded: new Date(), highlighted: true },
  { id: '2', caseId: '1', type: 'document', title: 'Original Lease Agreement', description: 'Section 8.2 details deposit return terms', dateAdded: new Date(), highlighted: false },
  { id: '3', caseId: '1', type: 'correspondence', title: 'Email Communications', description: 'All email exchanges with landlord', dateAdded: new Date(), highlighted: true },
  { id: '4', caseId: '1', type: 'receipt', title: 'Cleaning Service Receipt', description: 'Professional cleaning receipt dated Sept 14', dateAdded: new Date(), highlighted: false },
];
...
const EvidenceItem: Component<{ evidence: Evidence }> = (props) => {
  ...
  const typeIcons: Record<Evidence['type'], string> = {
    ...
    photo: 'M21 19V5C21 3.9 20.1 3 19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19ZM8.5 13.5L11 16.51L14.5 12L19 18H5L8.5 13.5Z',
    receipt: 'M19.5 3.5L18 2L16.5 3.5L15 2L13.5 3.5L12 2L10.5 3.5L9 2L7.5 3.5L6 2V22L7.5 20.5L9 22L10.5 20.5L12 22L13.5 20.5L15 22L16.5 20.5L18 22L19.5 20.5L21 22V2L19.5 3.5ZM18 19H9V17H18V19ZM18 15H9V13H18V15ZM18 11H9V9H18V11Z',
    correspondence: 'M20 4H4C2.9 4 2 4.9 2 6V18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V6C22 4.9 21.1 4 20 4ZM20 8L12 13L4 8V6L12 11L20 6V8Z',
    witness: 'M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 5C13.66 5 15 6.34 15 8C15 9.66 13.66 11 12 11C10.34 11 9 9.66 9 8C9 6.34 10.34 5 12 5ZM12 19.2C9.5 19.2 7.29 17.92 6 15.98C6.03 13.99 10 12.9 12 12.9C13.99 12.9 17.97 13.99 18 15.98C16.71 17.92 14.5 19.2 12 19.2Z',
  };
  ...
  return (
    ...
    >
      ...
      <svg width="20" height="20" viewBox="0 0 24 24" fill={daylight.colors.textMuted} style={{ 'flex-shrink': 0, opacity: isHovered() ? 1 : 0.3, transition: 'opacity 0.2s' }}>
...
export const JustInCaseApp: Component = () => {
  const [activeSection, setActiveSection] = createSignal<'overview' | 'evidence' | 'timeline'>('overview');
  ...
  return (
    <div style={{
      ...
      <div style={{ 'max-width': '900px', margin: '0 auto', padding: '40px 32px', position: 'relative' }}>
        {/* Header */}
        <header style={{ 'margin-bottom': '40px' }}>
          <div style={{ display: 'flex', 'align-items': 'center', gap: '12px', 'margin-bottom': '24px' }}>
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
              <rect x="6" y="4" width="24" height="28" rx="2" stroke={daylight.colors.primary} stroke-width="2" fill="none"/>
              <path d="M11 12H25M11 18H25M11 24H20" stroke={daylight.colors.primary} stroke-width="2" stroke-linecap="round"/>
          ...
          <p style={{
            ...
            color: daylight.colors.textMuted,
            'line-height': '1.6',
          }}>Build your small claims case with confidence.</p>
        </header>
        ...
        <article style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              'font-size': '15px',
              color: daylight.colors.textMuted,
            }}>vs. <HighlightedText color="blue">{sampleCase.defendant}</HighlightedText></p>
          </div>
          ...
          <nav style={{
            ...
            {(['overview', 'evidence', 'timeline'] as const).map(section => (
              <button
                ...
                style={{
                  ...
                  color: activeSection() === section ? daylight.colors.primary : daylight.colors.textMuted,
                  cursor: 'pointer',
