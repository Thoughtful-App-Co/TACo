...
export const ONET_KNOWLEDGE: OnetKnowledge[] = [
  ...
  },
  {
    ...
    description: 'Knowledge of the practical application of engineering science and technology.',
    domain: 'engineering',
  },
  {
    id: '2.C.3.c',
  ...
  },
  {
    ...
    description: 'Knowledge of different philosophical systems and religions.',
    domain: 'arts',
  },
...
export function findMatchingKnowledge(text: string): OnetKnowledge | null {
  ...
  return (
    ONET_KNOWLEDGE.find(
      (k) => lower.includes(k.name.toLowerCase()) || k.name.toLowerCase().includes(lower)
    ) || null
  );
}
